...
<body>
    ...
    <div class="side-bar fixed-top">
        ...
        <div class="menu">
            ...
            <div class="item"><a href="./formEditAkun.php?=<?php echo "" . $_SESSION['username'].""; ?>"><i class="fas fa-user"></i>Manajemen Akun</a></div>
    ...
    <div class="container card">
        ...
        <div class="card text-center">
            ...
            <form method="POST" action="editAkun.php">
                <div class="card-body">
                    <?php
                    $valueAdmin = mysqli_query($db, "SELECT * FROM user WHERE username='$_SESSION[username]'");
                    while ($editAdmin = mysqli_fetch_array($valueAdmin)) {
                    ?>
                        <input type="hidden" value="<?php echo $editAdmin['id'] ?>" name="id">
                        <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-user"></i></span>
                            <input type="text" class="form-control" placeholder="username" aria-label="username" name="username" value="<?php echo $editAdmin['username']; ?>" aria-describedby="addon-wrapping" required>
                        </div>
                        <br>
                        <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-key"></i></span>
                            <input type="password" class="form-control" placeholder="password" name="password" aria-label="password" value="<?php echo $editAdmin['password']; ?>" aria-describedby="addon-wrapping" required>
                        </div>
                        <br>
