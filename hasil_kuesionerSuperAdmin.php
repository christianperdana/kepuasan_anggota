...
<body>
    ...
    <div class="side-bar fixed-top">
        ...
        <div class="menu">
            ...
            <div class="item"><a href="./manajemenAdmin.php"><i class="fas fa-user"></i>Manajemen User</a></div>
            <div class="item"><a href="./hasil_kuesionerSuperAdmin.php"><i class="fas fa-external-link"></i>Hasil Kuisioner</a></div>
